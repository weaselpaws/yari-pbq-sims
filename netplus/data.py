...
QUESTIONS = [
    {
        "id": "seq1", "engine": "sequencing", "title": "Sequencing — OSI Model",
    ...
    {
        "id": "seq2", "engine": "sequencing", "title": "Sequencing — DHCP Lease Process",
    ...
    {
        "id": "match1", "engine": "matching", "title": "Matching — Well-Known Ports",
    ...
    {
        "id": "match2", "engine": "matching", "title": "Matching — Devices to OSI Layer",
    ...
    {
        "id": "calc1", "engine": "calculation", "title": "Calculation — Usable Hosts per Subnet",
    ...
    {
        "id": "calc2", "engine": "calculation", "title": "Calculation — Usable Hosts per Subnet",
    ...
    {
        "id": "class1", "engine": "classification", "title": "Classification — OSI Layer of the Fault",
    ...
    {
        "id": "class2", "engine": "classification", "title": "Classification — Network Topology",
    ...
    {
        "id": "topo1", "engine": "topology", "title": "Topology Builder — Small Office LAN",
        "scenario": (
    ...
    {
        "id": "term1", "engine": "terminal", "title": "CLI Simulator — Diagnose the Connection",
        "scenario": (
